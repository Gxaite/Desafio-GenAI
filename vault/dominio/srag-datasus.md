...
- Arquivos **particionados por ano** — um não contém o outro. "Últimos 12 meses" exige
  **os dois**; "últimos 30 dias" usa só o de 2026. Há ~1.649 casos de 2026 no arquivo de
  2025 (virada de ano) → **dedup** no ETL.
- **Características técnicas:** `;`, campos entre aspas, **194 colunas**, datas **ISO 8601**,
  encoding provável **latin-1**. Dicionário em `data/reference/`.
...
| `SG_UF` | UF | geografia — sensível ([[dados-sensiveis]]) |

## Ligações
Como viram números: [[metricas]] · Tratamento/carga: [[camada-dados]] · Privacidade: [[dados-sensiveis]]
