...
`.env` único** na raiz. Topologia em [[containerizacao]]:
...
## Consequências
- Ambiente reprodutível e isolado; `.env` como única fonte de parâmetros/segredos ([[dados-sensiveis]]).
...
## Relacionadas
[[containerizacao]] · [[estrutura-projeto]] · [[adr-0006-duckdb]] · [[adr-0014-grafana]] · [[adr-0009-tooling-uv-ruff-mypy]]
